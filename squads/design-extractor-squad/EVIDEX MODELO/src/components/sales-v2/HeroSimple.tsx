    ...
    <section className="relative pt-24 md:pt-32 pb-16 md:pb-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16 lg:mb-20 pt-8 md:pt-12 lg:pt-16">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 mb-3 max-w-5xl mx-auto leading-relaxed px-4 font-medium">
            Evidex captura e valida provas de entrega em 30 segundos.
          </p>
          
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 max-w-4xl mx-auto px-4">
            Motorista tira foto no WhatsApp → IA lê automaticamente → Pedido faturado. Pronto.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-[#01203f] rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <div className="text-[rgb(255,255,255)] text-lg">Do Canhoto ao Faturamento</div>
            </div>
            <div className="bg-[rgb(1,32,63)] rounded-2xl p-6 shadow-lg border border-gray-100">
              <div className="text-4xl md:text-5xl font-bold text-[#D4FF00] mb-2" style={{ textShadow: '0 0 20px rgba(212, 255, 0, 0.3)' }}>
                100%
              </div>
              <div className="text-[rgb(255,255,255)] text-lg">Automático via IA</div>
            </div>
            <div className="bg-[rgb(1,32,63)] rounded-2xl p-6 shadow-lg border border-gray-100">
              <div className="text-4xl md:text-5xl font-bold text-[#D4FF00] mb-2" style={{ textShadow: '0 0 20px rgba(212, 255, 0, 0.3)' }}>
                Zero
              </div>
              <div className="text-[rgb(255,255,255)] text-lg">Digitação Manual</div>
            </div>
          </div>
        </div>
      </div>
